...
public class Auth {
  ...
  /**
   * Generates a cryptographic key using a user password and a second string 'salt' as a starting point. 
  ...
  /**
   * Determines whether or not a given plain text password generates the same hashed password key
